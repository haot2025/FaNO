...
class FaNO_Block(nn.Module):
    ...
    def __init__(
        ...
        self.global_conv = SpectralConvS2_FaNO(forward_transform, inverse_transform, input_dim, input_dim, gain=gain_factor, bias=True)

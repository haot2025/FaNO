...
from .module_FaNO import GlobalForecastModule
...
def main():
    ...
    cli.trainer.test(cli.model, datamodule=cli.datamodule, ckpt_path="FaNO/global_forecast/5day/checkpoints/epoch_013.ckpt")

...
class CylinderFlowBase(Dataset):
    def __init__(self, root_dir, data=None, mode='train', k_eig=128, use_cache=True, op_cache_dir=None, **kwargs):
        ...
        self.frames_list, self.massvec_list, self.L_list, self.evals_list, self.evecs_list,self.edges_list, self.curv_list = diffusion_net.geometry.get_all_operators(self.verts_list, self.faces_list, k_eig=self.k_eig, op_cache_dir=self.op_cache_dir)
